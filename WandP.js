...
fetch('http://localhost:3000/user/workspaces')
  ...
  .then(workspaces => {
    ...
    workspaces.forEach(workspace => {
      ...
      availabilityDate.textContent = 'Availability Date: ' + workspace.availabilityDate  + new Date(property.availabilityDate).toLocaleDateString('en-US',  ({ year: 'numeric', month: 'short', day: 'numeric' }) );;
